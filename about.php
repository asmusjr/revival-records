		...
		<div class="container">
			<div class="row vertical-align">
				<div class="col-md-4 main-content scrollable">
					...
					<!--<h2 class="content-header">ABOUT
                    	<input id="store-button" type="button" onclick="changeToStoreText(this)" class="about-btn-style" value="the store"/> 
                   		<span style="color:#6B6B6B">|</span> 
                        <input id="record-button" type="button" onclick="changeToRecordText(this)" class="about-btn-style" value="the records"/>
                    </h2>-->
